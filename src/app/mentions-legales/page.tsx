    ...
    <main className="pt-16">
      <div className="max-w-3xl mx-auto px-6 py-20">
        <h1
          ...
          className="text-4xl font-light text-[#2D2D2D] mb-10"
        >
          Mentions Légales
        </h1>
        ...
        <div className="space-y-8 text-sm text-[#7A7A7A] leading-relaxed">
          <section>
            <h2 className="text-base font-medium text-[#2D2D2D] mb-2">Éditeur du site</h2>
            <p>Maison Sophie</p>
          ...
          <section>
            <h2 className="text-base font-medium text-[#2D2D2D] mb-2">Hébergement</h2>
            <p>Ce site est hébergé par Vercel Inc., 340 Pine Street, Suite 701, San Francisco, CA 94104, USA.</p>
          </section>

          <section>
            <h2 className="text-base font-medium text-[#2D2D2D] mb-2">Propriété intellectuelle</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-[#2D2D2D] mb-2">Données personnelles</h2>
            <p>
