...
{/* ── PRÉSENTATION SOPHIE ── */}
      <section className="bg-[#EAE5DC] py-24 px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-12 items-center">
          {/* Photo */}
          <div className="relative pb-10 pr-10 lg:pb-14 lg:pr-14 w-72 lg:w-80 mx-auto lg:mx-0">
